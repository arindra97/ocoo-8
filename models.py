...
class Course(models.Model):
    ...
    price = fields.Float(help="price of course")
...
class Session(models.Model):
    ...
    attendees_count = fields.Integer(string="Attendees count", compute='_get_attendes_count', store=True)
